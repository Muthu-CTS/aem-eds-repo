...
## Environments
- Preview: https://main--aem-eds-repo--Muthu-CTS.aem.page/
- Live: https://main--aem-eds-repo--Muthu-CTS.aem.live/
...
1. Open the `aem-eds-repo` directory in your favorite IDE and start coding :)
